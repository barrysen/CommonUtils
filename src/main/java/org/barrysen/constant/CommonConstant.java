...
public class CommonConstant {
     ...
     * 账户状态 冻结
     */
    public static final Integer ACCOUNT_STATUS_FREEZE = 2;
     ...
     * 默认首页
     */
    public static final Integer DEFAULT_FLAG_1 = 1;

    /**
     * 非默认
     */
    public static final Integer DEFAULT_FLAG_0 = 0;
    ...
    /**
     * 操作方式: 消息通知 sms  会设置任务名称、任务code
     */
    public static final String OPERATE_MODE_1 = "sms";
    /**
     * 操作方式: 消息通知 sms（参数实体执行）  会设置任务名称、任务code
     */
    public static final String OPERATE_MODE_2 = "sms_entity";
    ...
    public static final Integer NO_PAGE_FOUND = 404;

    public static final Integer UN_SUPPORTED = 405;
     ...
     * 登录用户Token令牌缓存KEY前缀
     */
    public static final String PREFIX_USER_TOKEN = "prefix__user_token_";
    /**
     * 登录外部应用用户Token令牌缓存KEY前缀
     */
    public static final String PREFIX_OUTSIDE_APP_TOKEN = "outside_app_token_";
    /**
     * Token缓存时间：7200秒即2小时
     */
    ...
    /**
     * sys_user_info 表 username 唯一键索引
     */
    public static final String SQL_INDEX_UNIQ_SYS_USER_USERNAME = "uniq_sys_user_username";
    /**
     * sys_user_info 表 work_no 唯一键索引
     */
    public static final String SQL_INDEX_UNIQ_SYS_USER_WORK_NO = "uniq_sys_user_work_no";
    /**
     * sys_user_info 表 phone 唯一键索引
     */
    public static final String SQL_INDEX_UNIQ_SYS_USER_PHONE = "uniq_sys_user_phone";
    /**
     * sys_user_info 表 email 唯一键索引
     */
     ...
     * 通过密码验证
     */
    public final static Integer LOGIN_VALID_TYPE_PASSWORD = 1;

    /**
     * 通过REST验证
     */
    public final static Integer LOGIN_VALID_TYPE_REST = 2;

    /**
     * 周报查看编码：1查看页面，2编辑页面
     */
    public final static String WEEK_SHOW_CODE_1 = "1";

    /**
     * 周报查看编码：1查看页面，2编辑页面
     */
    public final static String WEEK_SHOW_CODE_2 = "2";
}
